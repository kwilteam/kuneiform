...
func kuneiformparserParserInit() {
	...
	staticData.literalNames = []string{
		...
		"'public'", "'private'", "'view'", "'owner'", "'int'", "'text'", "'blob'",
		"'min'", "'max'", "'minlen'", "'maxlen'", "'notnull'", "'primary'",
	...
	staticData.symbolicNames = []string{
		...
		"OR_", "IDENTIFIER", "INDEX_NAME", "PARAM_OR_VAR", "BLOCK_VAR_OR_ANNOTATION",
	...
	staticData.serializedATN = []int32{
		...
		90, 92, 94, 96, 98, 100, 0, 14, 1, 0, 41, 43, 1, 0, 77, 78, 2, 0, 49, 49,
		51, 52, 1, 0, 57, 58, 1, 0, 60, 64, 1, 0, 53, 54, 1, 0, 55, 56, 1, 0, 37,
		38, 2, 0, 13, 14, 18, 18, 1, 0, 15, 17, 1, 0, 13, 14, 1, 0, 20, 23, 1,
		0, 25, 28, 3, 0, 12, 12, 24, 24, 29, 30, 457, 0, 102, 1, 0, 0, 0, 2, 120,
		1, 0, 0, 0, 4, 123, 1, 0, 0, 0, 6, 135, 1, 0, 0, 0, 8, 143, 1, 0, 0, 0,
		10, 147, 1, 0, 0, 0, 12, 152, 1, 0, 0, 0, 14, 160, 1, 0, 0, 0, 16, 164,
		1, 0, 0, 0, 18, 183, 1, 0, 0, 0, 20, 191, 1, 0, 0, 0, 22, 199, 1, 0, 0,
		0, 24, 229, 1, 0, 0, 0, 26, 231, 1, 0, 0, 0, 28, 233, 1, 0, 0, 0, 30, 235,
		1, 0, 0, 0, 32, 241, 1, 0, 0, 0, 34, 247, 1, 0, 0, 0, 36, 262, 1, 0, 0,
		0, 38, 264, 1, 0, 0, 0, 40, 266, 1, 0, 0, 0, 42, 273, 1, 0, 0, 0, 44, 279,
		1, 0, 0, 0, 46, 293, 1, 0, 0, 0, 48, 302, 1, 0, 0, 0, 50, 304, 1, 0, 0,
		0, 52, 306, 1, 0, 0, 0, 54, 308, 1, 0, 0, 0, 56, 310, 1, 0, 0, 0, 58, 312,
		1, 0, 0, 0, 60, 314, 1, 0, 0, 0, 62, 316, 1, 0, 0, 0, 64, 324, 1, 0, 0,
		0, 66, 326, 1, 0, 0, 0, 68, 328, 1, 0, 0, 0, 70, 330, 1, 0, 0, 0, 72, 332,
		1, 0, 0, 0, 74, 334, 1, 0, 0, 0, 76, 342, 1, 0, 0, 0, 78, 348, 1, 0, 0,
		0, 80, 350, 1, 0, 0, 0, 82, 356, 1, 0, 0, 0, 84, 361, 1, 0, 0, 0, 86, 369,
		1, 0, 0, 0, 88, 374, 1, 0, 0, 0, 90, 376, 1, 0, 0, 0, 92, 378, 1, 0, 0,
		0, 94, 384, 1, 0, 0, 0, 96, 386, 1, 0, 0, 0, 98, 389, 1, 0, 0, 0, 100,
		425, 1, 0, 0, 0, 102, 103, 3, 2, 1, 0, 103, 107, 5, 2, 0, 0, 104, 106,
		3, 4, 2, 0, 105, 104, 1, 0, 0, 0, 106, 109, 1, 0, 0, 0, 107, 105, 1, 0,
		0, 0, 107, 108, 1, 0, 0, 0, 108, 115, 1, 0, 0, 0, 109, 107, 1, 0, 0, 0,
		110, 114, 3, 16, 8, 0, 111, 114, 3, 44, 22, 0, 112, 114, 3, 74, 37, 0,
		113, 110, 1, 0, 0, 0, 113, 111, 1, 0, 0, 0, 113, 112, 1, 0, 0, 0, 114,
		117, 1, 0, 0, 0, 115, 113, 1, 0, 0, 0, 115, 116, 1, 0, 0, 0, 116, 118,
		1, 0, 0, 0, 117, 115, 1, 0, 0, 0, 118, 119, 5, 0, 0, 1, 119, 1, 1, 0, 0,
		0, 120, 121, 5, 31, 0, 0, 121, 122, 3, 50, 25, 0, 122, 3, 1, 0, 0, 0, 123,
		124, 5, 32, 0, 0, 124, 129, 3, 52, 26, 0, 125, 126, 5, 4, 0, 0, 126, 127,
		3, 6, 3, 0, 127, 128, 5, 6, 0, 0, 128, 130, 1, 0, 0, 0, 129, 125, 1, 0,
		0, 0, 129, 130, 1, 0, 0, 0, 130, 131, 1, 0, 0, 0, 131, 132, 5, 33, 0, 0,
		132, 133, 3, 52, 26, 0, 133, 134, 5, 2, 0, 0, 134, 5, 1, 0, 0, 0, 135,
		140, 3, 8, 4, 0, 136, 137, 5, 7, 0, 0, 137, 139, 3, 8, 4, 0, 138, 136,
		1, 0, 0, 0, 139, 142, 1, 0, 0, 0, 140, 138, 1, 0, 0, 0, 140, 141, 1, 0,
		0, 0, 141, 7, 1, 0, 0, 0, 142, 140, 1, 0, 0, 0, 143, 144, 3, 54, 27, 0,
		144, 145, 5, 1, 0, 0, 145, 146, 3, 72, 36, 0, 146, 9, 1, 0, 0, 0, 147,
		148, 3, 66, 33, 0, 148, 149, 5, 3, 0, 0, 149, 150, 3, 12, 6, 0, 150, 151,
		5, 5, 0, 0, 151, 11, 1, 0, 0, 0, 152, 157, 3, 14, 7, 0, 153, 154, 5, 7,
		0, 0, 154, 156, 3, 14, 7, 0, 155, 153, 1, 0, 0, 0, 156, 159, 1, 0, 0, 0,
		157, 155, 1, 0, 0, 0, 157, 158, 1, 0, 0, 0, 158, 13, 1, 0, 0, 0, 159, 157,
		1, 0, 0, 0, 160, 161, 3, 68, 34, 0, 161, 162, 5, 12, 0, 0, 162, 163, 3,
		70, 35, 0, 163, 15, 1, 0, 0, 0, 164, 165, 5, 34, 0, 0, 165, 166, 3, 56,
		28, 0, 166, 167, 5, 4, 0, 0, 167, 175, 3, 20, 10, 0, 168, 171, 5, 7, 0,
		0, 169, 172, 3, 30, 15, 0, 170, 172, 3, 34, 17, 0, 171, 169, 1, 0, 0, 0,
		171, 170, 1, 0, 0, 0, 172, 174, 1, 0, 0, 0, 173, 168, 1, 0, 0, 0, 174,
		177, 1, 0, 0, 0, 175, 173, 1, 0, 0, 0, 175, 176, 1, 0, 0, 0, 176, 179,
		1, 0, 0, 0, 177, 175, 1, 0, 0, 0, 178, 180, 5, 7, 0, 0, 179, 178, 1, 0,
		0, 0, 179, 180, 1, 0, 0, 0, 180, 181, 1, 0, 0, 0, 181, 182, 5, 6, 0, 0,
		182, 17, 1, 0, 0, 0, 183, 184, 3, 60, 30, 0, 184, 188, 3, 22, 11, 0, 185,
		187, 3, 24, 12, 0, 186, 185, 1, 0, 0, 0, 187, 190, 1, 0, 0, 0, 188, 186,
		1, 0, 0, 0, 188, 189, 1, 0, 0, 0, 189, 19, 1, 0, 0, 0, 190, 188, 1, 0,
		0, 0, 191, 196, 3, 18, 9, 0, 192, 193, 5, 7, 0, 0, 193, 195, 3, 18, 9,
		0, 194, 192, 1, 0, 0, 0, 195, 198, 1, 0, 0, 0, 196, 194, 1, 0, 0, 0, 196,
		197, 1, 0, 0, 0, 197, 21, 1, 0, 0, 0, 198, 196, 1, 0, 0, 0, 199, 200, 7,
		0, 0, 0, 200, 23, 1, 0, 0, 0, 201, 230, 5, 49, 0, 0, 202, 230, 5, 48, 0,
		0, 203, 230, 5, 51, 0, 0, 204, 205, 5, 50, 0, 0, 205, 206, 5, 3, 0, 0,
		206, 207, 3, 26, 13, 0, 207, 208, 5, 5, 0, 0, 208, 230, 1, 0, 0, 0, 209,
		210, 5, 44, 0, 0, 210, 211, 5, 3, 0, 0, 211, 212, 3, 28, 14, 0, 212, 213,
		5, 5, 0, 0, 213, 230, 1, 0, 0, 0, 214, 215, 5, 45, 0, 0, 215, 216, 5, 3,
		0, 0, 216, 217, 3, 28, 14, 0, 217, 218, 5, 5, 0, 0, 218, 230, 1, 0, 0,
		0, 219, 220, 5, 46, 0, 0, 220, 221, 5, 3, 0, 0, 221, 222, 3, 28, 14, 0,
		222, 223, 5, 5, 0, 0, 223, 230, 1, 0, 0, 0, 224, 225, 5, 47, 0, 0, 225,
		226, 5, 3, 0, 0, 226, 227, 3, 28, 14, 0, 227, 228, 5, 5, 0, 0, 228, 230,
		1, 0, 0, 0, 229, 201, 1, 0, 0, 0, 229, 202, 1, 0, 0, 0, 229, 203, 1, 0,
		0, 0, 229, 204, 1, 0, 0, 0, 229, 209, 1, 0, 0, 0, 229, 214, 1, 0, 0, 0,
		229, 219, 1, 0, 0, 0, 229, 224, 1, 0, 0, 0, 230, 25, 1, 0, 0, 0, 231, 232,
		7, 1, 0, 0, 232, 27, 1, 0, 0, 0, 233, 234, 5, 77, 0, 0, 234, 29, 1, 0,
		0, 0, 235, 236, 3, 64, 32, 0, 236, 237, 7, 2, 0, 0, 237, 238, 5, 3, 0,
		0, 238, 239, 3, 62, 31, 0, 239, 240, 5, 5, 0, 0, 240, 31, 1, 0, 0, 0, 241,
		243, 7, 3, 0, 0, 242, 244, 5, 59, 0, 0, 243, 242, 1, 0, 0, 0, 243, 244,
		1, 0, 0, 0, 244, 245, 1, 0, 0, 0, 245, 246, 7, 4, 0, 0, 246, 33, 1, 0,
		0, 0, 247, 248, 7, 5, 0, 0, 248, 249, 5, 3, 0, 0, 249, 250, 3, 62, 31,
		0, 250, 251, 5, 5, 0, 0, 251, 252, 7, 6, 0, 0, 252, 253, 3, 56, 28, 0,
		253, 254, 5, 3, 0, 0, 254, 255, 3, 62, 31, 0, 255, 259, 5, 5, 0, 0, 256,
		258, 3, 32, 16, 0, 257, 256, 1, 0, 0, 0, 258, 261, 1, 0, 0, 0, 259, 257,
		1, 0, 0, 0, 259, 260, 1, 0, 0, 0, 260, 35, 1, 0, 0, 0, 261, 259, 1, 0,
		0, 0, 262, 263, 7, 7, 0, 0, 263, 37, 1, 0, 0, 0, 264, 265, 5, 39, 0, 0,
		265, 39, 1, 0, 0, 0, 266, 267, 5, 40, 0, 0, 267, 41, 1, 0, 0, 0, 268, 272,
		3, 36, 18, 0, 269, 272, 3, 38, 19, 0, 270, 272, 3, 40, 20, 0, 271, 268,
		1, 0, 0, 0, 271, 269, 1, 0, 0, 0, 271, 270, 1, 0, 0, 0, 272, 275, 1, 0,
		0, 0, 273, 271, 1, 0, 0, 0, 273, 274, 1, 0, 0, 0, 274, 43, 1, 0, 0, 0,
		275, 273, 1, 0, 0, 0, 276, 278, 3, 10, 5, 0, 277, 276, 1, 0, 0, 0, 278,
		281, 1, 0, 0, 0, 279, 277, 1, 0, 0, 0, 279, 280, 1, 0, 0, 0, 280, 282,
		1, 0, 0, 0, 281, 279, 1, 0, 0, 0, 282, 283, 5, 35, 0, 0, 283, 284, 3, 58,
		29, 0, 284, 285, 5, 3, 0, 0, 285, 286, 3, 46, 23, 0, 286, 287, 5, 5, 0,
		0, 287, 288, 3, 42, 21, 0, 288, 289, 5, 4, 0, 0, 289, 290, 3, 76, 38, 0,
		290, 291, 5, 6, 0, 0, 291, 45, 1, 0, 0, 0, 292, 294, 3, 48, 24, 0, 293,
		292, 1, 0, 0, 0, 293, 294, 1, 0, 0, 0, 294, 299, 1, 0, 0, 0, 295, 296,
		5, 7, 0, 0, 296, 298, 3, 48, 24, 0, 297, 295, 1, 0, 0, 0, 298, 301, 1,
		0, 0, 0, 299, 297, 1, 0, 0, 0, 299, 300, 1, 0, 0, 0, 300, 47, 1, 0, 0,
		0, 301, 299, 1, 0, 0, 0, 302, 303, 5, 75, 0, 0, 303, 49, 1, 0, 0, 0, 304,
		305, 5, 73, 0, 0, 305, 51, 1, 0, 0, 0, 306, 307, 5, 73, 0, 0, 307, 53,
		1, 0, 0, 0, 308, 309, 5, 73, 0, 0, 309, 55, 1, 0, 0, 0, 310, 311, 5, 73,
		0, 0, 311, 57, 1, 0, 0, 0, 312, 313, 5, 73, 0, 0, 313, 59, 1, 0, 0, 0,
		314, 315, 5, 73, 0, 0, 315, 61, 1, 0, 0, 0, 316, 321, 3, 60, 30, 0, 317,
		318, 5, 7, 0, 0, 318, 320, 3, 60, 30, 0, 319, 317, 1, 0, 0, 0, 320, 323,
		1, 0, 0, 0, 321, 319, 1, 0, 0, 0, 321, 322, 1, 0, 0, 0, 322, 63, 1, 0,
		0, 0, 323, 321, 1, 0, 0, 0, 324, 325, 5, 74, 0, 0, 325, 65, 1, 0, 0, 0,
		326, 327, 5, 76, 0, 0, 327, 67, 1, 0, 0, 0, 328, 329, 5, 73, 0, 0, 329,
		...
		350, 351, 5, 80, 0, 0, 351, 352, 5, 2, 0, 0, 352, 81, 1, 0, 0, 0, 353,
		...
		0, 0, 374, 375, 5, 75, 0, 0, 375, 89, 1, 0, 0, 0, 376, 377, 5, 76, 0, 0,
		377, 91, 1, 0, 0, 0, 378, 379, 5, 73, 0, 0, 379, 380, 5, 11, 0, 0, 380,
		381, 5, 73, 0, 0, 381, 93, 1, 0, 0, 0, 382, 385, 3, 92, 46, 0, 383, 385,
		3, 58, 29, 0, 384, 382, 1, 0, 0, 0, 384, 383, 1, 0, 0, 0, 385, 95, 1, 0,
		0, 0, 386, 387, 5, 73, 0, 0, 387, 97, 1, 0, 0, 0, 388, 390, 3, 100, 50,
		...
		407, 7, 8, 0, 0, 407, 426, 3, 100, 50, 11, 408, 409, 5, 70, 0, 0, 409,
		...
		0, 429, 452, 3, 100, 50, 11, 430, 431, 10, 9, 0, 0, 431, 432, 7, 9, 0,
		0, 432, 452, 3, 100, 50, 10, 433, 434, 10, 8, 0, 0, 434, 435, 7, 10, 0,
		0, 435, 452, 3, 100, 50, 9, 436, 437, 10, 7, 0, 0, 437, 438, 7, 11, 0,
		0, 438, 452, 3, 100, 50, 8, 439, 440, 10, 6, 0, 0, 440, 441, 7, 12, 0,
		0, 441, 452, 3, 100, 50, 7, 442, 443, 10, 5, 0, 0, 443, 444, 7, 13, 0,
		0, 444, 452, 3, 100, 50, 6, 445, 446, 10, 3, 0, 0, 446, 447, 5, 71, 0,
		0, 447, 452, 3, 100, 50, 4, 448, 449, 10, 2, 0, 0, 449, 450, 5, 72, 0,
...
const (
	...
	KuneiformParserOWNER_                  = 40
	KuneiformParserINT_                    = 41
	KuneiformParserTEXT_                   = 42
	KuneiformParserBLOB_                   = 43
	KuneiformParserMIN_                    = 44
	KuneiformParserMAX_                    = 45
	KuneiformParserMIN_LEN_                = 46
	KuneiformParserMAX_LEN_                = 47
	KuneiformParserNOT_NULL_               = 48
	KuneiformParserPRIMARY_                = 49
	KuneiformParserDEFAULT_                = 50
	KuneiformParserUNIQUE_                 = 51
	KuneiformParserINDEX_                  = 52
	KuneiformParserFOREIGN_KEY_            = 53
	KuneiformParserFOREIGN_KEY_ABBR_       = 54
	KuneiformParserREFERENCES_             = 55
	KuneiformParserREFERENCES_ABBR_        = 56
	KuneiformParserACTION_ON_UPDATE_       = 57
	KuneiformParserACTION_ON_DELETE_       = 58
	KuneiformParserACTION_DO_              = 59
	KuneiformParserACTION_DO_NO_ACTION_    = 60
	KuneiformParserACTION_DO_CASCADE_      = 61
	KuneiformParserACTION_DO_SET_NULL_     = 62
	KuneiformParserACTION_DO_SET_DEFAULT_  = 63
	KuneiformParserACTION_DO_RESTRICT_     = 64
	KuneiformParserSELECT_                 = 65
	KuneiformParserINSERT_                 = 66
	KuneiformParserUPDATE_                 = 67
	KuneiformParserDELETE_                 = 68
	KuneiformParserWITH_                   = 69
	KuneiformParserNOT_                    = 70
	KuneiformParserAND_                    = 71
	KuneiformParserOR_                     = 72
	KuneiformParserIDENTIFIER              = 73
	KuneiformParserINDEX_NAME              = 74
	KuneiformParserPARAM_OR_VAR            = 75
	KuneiformParserBLOCK_VAR_OR_ANNOTATION = 76
	KuneiformParserUNSIGNED_NUMBER_LITERAL = 77
	KuneiformParserSTRING_LITERAL          = 78
	KuneiformParserSQL_KEYWORDS            = 79
	KuneiformParserSQL_STMT                = 80
	KuneiformParserWS                      = 81
	KuneiformParserTERMINATOR              = 82
	KuneiformParserBLOCK_COMMENT           = 83
	KuneiformParserLINE_COMMENT            = 84
)
